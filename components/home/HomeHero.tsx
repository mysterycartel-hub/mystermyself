    ...
    <section id="start-here" className="hero" style={{
      ...
      >
        <svg viewBox="0 0 380 300" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto' }}>
          ...
          <line x1="116" y1="195" x2="116" y2="135" stroke="#c9a84c" strokeWidth="1.5" filter="url(#glow-home)"/>
          <rect x="108" y="145" width="16" height="40" fill="#c9a84c" opacity="0.9" filter="url(#glow-home)"/>
          <line x1="150" y1="170" x2="150" y2="110" stroke="#c9a84c" strokeWidth="1.5" filter="url(#glow-home)"/>
          <rect x="142" y="118" width="16" height="44" fill="#c9a84c" filter="url(#glow-home)"/>
          <line x1="184" y1="155" x2="184" y2="85" stroke="#c9a84c" strokeWidth="1.5" filter="url(#glow-home)"/>
          <rect x="176" y="92" width="16" height="56" fill="#c9a84c" filter="url(#glow-home)"/>
          <line x1="218" y1="130" x2="218" y2="70" stroke="#c9a84c" strokeWidth="1.5" filter="url(#glow-home)"/>
          <rect x="210" y="78" width="16" height="46" fill="#c9a84c" filter="url(#glow-home)"/>
          <line x1="252" y1="105" x2="252" y2="50" stroke="#c9a84c" strokeWidth="1.5" filter="url(#glow-home)"/>
          <rect x="244" y="58" width="16" height="42" fill="#c9a84c" filter="url(#glow-home)"/>
