...
const divisions = [
  ...
  },
  {
    ...
    subtitle: 'Business HQ · Creator Hub · Ownership Education',
    desc: 'The business headquarters of the ecosystem. Creator economy meets ownership education — building real assets, not just content.',
    href: '/about',
    tag: 'Ownership',
    accent: '#7a6230',
  },
  {
    ...
    subtitle: 'Medical Courier · Contract Routes · Logistics City · Systems',
    desc: 'The research lab for road-based income. Medical courier routes, contract delivery, route acquisition, and logistics business systems.',
